...
public final class LaunchesQuery: GraphQLQuery {
  ...
  public struct Data: GraphQLSelectionSet {
    ...
    public struct LaunchesPast: GraphQLSelectionSet {
      ...
      public init(id: GraphQLID? = nil, missionId: [String?]? = nil, missionName: String? = nil, details: String? = nil, launchDateUnix: String? = nil, rocket: Rocket? = nil, links: Link? = nil) {
        self.init(unsafeResultMap: ["__typename": "Launch", "id": id, "mission_id": missionId, "mission_name": missionName, "details": details, "launch_date_unix": launchDateUnix, "rocket": rocket.flatMap { (value: Rocket) -> ResultMap in value.resultMap }, "links": links.flatMap { (value: Link) -> ResultMap in value.resultMap }])
      }
